...
| Docker Compose | 部分实现 | API 基础服务、`observability` profile（OTel Collector/Prometheus）和 Grafana provisioning artifact 已配置；尚无 Grafana 容器、数据库、Redis、Worker 等完整生产栈 |
