...
| TD-007 | 中间件若启用会记录完整工具参数和消息正文 | High | Prompt、PII、报告参数或文档内容进入日志 | `agent/tools/middleware.py`、`src/app/security/redaction.py` | 已改为参数键/类型摘要、消息长度/指纹和异常类型；继续评估 middleware 是否应正式接线 | 8/9 | 已完成（接线策略待定） |
