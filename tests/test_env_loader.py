...
class EnvLoaderTest(unittest.TestCase):
    def test_plain_value_is_preserved(self) -> None:
        self.assertEqual(clean_env_value("https://api.deepseek.com/anthropic"), "https://api.deepseek.com/anthropic")

    def test_markdown_link_value_uses_url(self) -> None:
        value = "[https://api.deepseek.com/anthropic](https://api.deepseek.com/anthropic)"
