...
def test_sqlalchemy_ingestion_repository_recovers_documents_and_jobs() -> None:
    ...
    try:
        ...
        assert (
            second.delete(tenant_id="tenant-a", document_id=record.document_id).status
